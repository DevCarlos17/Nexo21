...
(Previously: solo listaba facturas elegibles para emisión de NC, sin buscador ni indicación de estado/reverso)
...
(Previously: el PIN de emisión (a) solo gateaba el flujo de emisión de NC; ahora gatea también el botón placeholder "Editar métodos de pago")
